...
.controller('menuCtrl',  // The following is the constructor function for this page's controller. See https://docs.angularjs.org/guide/controller
    ...
    function ($scope, $stateParams) {
        ...
        $scope.launchcomet=function(){
             alert("vaatt")
    Readyui.setUrl("https://demo.phpchatsoftware.com/dolpin/cometchat");
    Readyui.login("John","passw0rd",mycallback);
...
.controller('loginCtrl', // The following is the constructor function for this page's controller. See https://docs.angularjs.org/guide/controller
    ...
    function ($scope, $state, $http, $cordovaOauth, $ionicPopup, $cordovaToast, $ionicLoading, $ionicPlatform, $ionicSideMenuDelegate, $stateParams, $ionicPopover, $ionicModal, $timeout, ngFB) {
                ...
                if (result.access_token) {
                    $http.get("https://graph.facebook.com/v2.2/me", {
                        ...
                        if (result.data) {
                            ...
                            $http({
                                method: 'POST',
                                url: ' http://millionsopportunities.international/webservicefb_login',
                                data: {
        ...
        $scope.login = function () {
            ...
            $http({
                method: 'POST',
                url: ' http://millionsopportunities.international/webservicelogin',
                data: {
                    'email': $scope.user.email,
                    'password': $scope.user.password,
                    'device_id':'1234565523',
                    'device_type':'Android',
                    'device_token':'ghcagdhhjdajdcuahsfwusdqjawedui'
                },
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
                }
                ...
                $ionicLoading.hide();
                console.log("pagal" + data.response)
                if (data.response=='true' || data.response==true) {
                    ...
                    console.log('user_id' + localStorage['rEmail']);
                    console.log('user_name' + localStorage['username']);
                    logsuc();
                    //localStorage.setItem('status', data.result.status);
                } else {
                    logfail();
        ...
        sererror = function () {
                    var alertPopup = $ionicPopup.alert({
                        title: 'Alert',
                        template: 'Please check your Net Connection Or Try again later!! '
                    });
                    alertPopup.then(function (res) {
                        console.log('Logged-In successfully! ');
                       // $state.go('tabsController.millionOpportunities');
...
.controller('signupCtrl', // The following is the constructor function for this page's controller. See https://docs.angularjs.org/guide/controller
    ...
    function ($scope, $state, $http, $ionicPopup, $ionicLoading, $ionicPlatform, $ionicSideMenuDelegate, $stateParams, $ionicPopover) {
        ...
        $scope.signup = function () {
            ...
            $http({
                method: 'POST',
                url: ' http://millionsopportunities.international/webservicesign_up',
                data: {
...
.controller('postAddCtrl',
    function ($scope, $state, $http, $ionicPopup, $cordovaFileTransfer, $ionicLoading, $ionicPlatform, $ionicSideMenuDelegate, $stateParams, $ionicPopover, $cordovaCamera, $cordovaImagePicker) {
        ...
        $scope.$on('$ionicView.beforeEnter', function (event, viewData) {
            ...
            //                       //  $http({
            //                       //  method: 'POST',
            //                       //  url: ' http://millionsopportunities.international/webserviceprice', 
            //                       //  data: {}, 
            //                       //  headers: 
            //                       //  {
            //                       //  'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
        ...
        $ionicLoading.show({
            ...
            $http({
                method: 'post',
                url: ' http://millionsopportunities.international/webserviceclick_post_id',
                data: {
                ...
                if (data.response) {
                    ...
                    $scope.post_category=data.categories;
         ...
         $scope.subcat=function(a){
            ...
            $http({
                method: 'post',
                url: ' http://millionsopportunities.international/webservicesubcat',
                data: {
                     'category':webcat
                },
                headers: {
                ...
                if (data) {
                   ...
                   $scope.post_subcategory=data.subcategories;


                // }else{
                //      $scope.subcategory='No Subcategories Found';
                }
                console.log('postid page 1 ' + localStorage['post_id'])
            }).error(function (data, status, header, config, message) {
                sererror();
        ...
        $scope.next = function (data) {
            ...
            if (data == 'Motors') {
                ...
                localStorage.setItem('contact', $scope.contactno);
                localStorage.setItem('email', $scope.email);
                localStorage.setItem('category', $scope.post_category);
                localStorage.setItem('subcategory', $scope.post_subcategory);
...
.controller('postAddCtrl2',
        function ($scope, $state, $http, $ionicPopup, $cordovaFileTransfer, $ionicLoading, $ionicPlatform, $ionicSideMenuDelegate, $stateParams, $ionicPopover, $cordovaCamera, $cordovaImagePicker) {
            ...
            $scope.post = function (a, b, c, d, e, f) {
                ...
                if ($scope.check2 != true) {
                    var website = 0;
                    var websitepost=null;
                } else {
                    var website = $scope.pricelist.web.price;
                    var websitepost=$scope.pricelist.web.price;
                    //var webduration=
                }
                ...
                if ($scope.check3 != true) {
                    var youtube = 0;
                    var youtubepost = null;
                } else {
                    var youtube = $scope.pricelist.youtube.price;
                    var youtubepost = $scope.pricelist.youtube.price;
                    //var webduration=
                }
                ...
                if ($scope.check4 != true) {
                    ...
                    var urgentpost = $scope.important.split("$").pop();
                ...
                if ($scope.check5 != true) {
                    ...
                    var featuredpost = $scope.recommended.split("$").pop();
                ...
                if ($scope.check6 != true) {
                    ...
                    var spolightpost = $scope.flashlight.split("$").pop();
                ...
                confirmPopup.then(function (res) {
                    if (res) {
                        ...
                        $http({
                            method: 'POST',
                            url: ' http://millionsopportunities.international/webservicepost_ad',
                            data: {
                                ...
                                'web_check': websitepost,
                                'you_check': youtubepost,
                                'urgent': urgentpost,
                                'urgent_duration': urgent_time,
                                'featured': featuredpost,
                                'featured_duration': featured_time,
                                'spolight': spolightpost,
            ...
            $scope.takePicture = function (options) {
                ...
                $cordovaCamera.getPicture(options).then(function (imageData) {
                    var url = encodeURI(" http://millionsopportunities.international/webserviceupload_photo/" + localStorage['post_id'] + '/' + localStorage['rEmail']);
    ...
    .controller('stripeCtrl', // The following is the constructor function for this page's controller. See https://docs.angularjs.org/guide/controller
        ...
        function ($scope, $state, $http, $ionicPopup, $ionicLoading, $cordovaFileTransfer, $cordovaDevice, $ionicPlatform, $ionicSideMenuDelegate, $stateParams, $ionicPopover) {
            ...
            pay = function (results) {
                ...
                $http({
                    method: 'POST',
                    url: ' http://millionsopportunities.international/webservicepayment',
                    data: {
        ...
        function ($scope, $state, $http, $ionicPopup, $ionicLoading, $cordovaFileTransfer, $ionicPopover, $cordovaDevice, $ionicPlatform, $ionicSideMenuDelegate, $stateParams, $cordovaSocialSharing) {
            ...
            $scope.$on('$ionicView.beforeEnter', function (event, viewData) {
                ...
                $scope.openPopover = function ($event, data) {
                    ...
                    localStorage.setItem('image_id', image)
                    console.log("local localStorage" + localStorage['image_id'])
                ...
                $http({
                    method: 'post',
                    url: ' http://millionsopportunities.international//webservicead_details',
                    data: {
                        'id': id,
                ...
                $scope.shareAnywhere = function (dis, title, image) {
                    ...
                    var title = title;
                    var image = image;
                    var c_image = " http://millionsopportunities.international/uploads/" + image.replace('[', '').replace('"', '').replace('"', '').replace(']', '');
                    ...
                    $cordovaSocialSharing.share(discription, title, c_image, " http://millionsopportunities.international/");
                }
                ...
                $scope.addfavorite = function (id) {
                    ...
                    $http({
                        method: 'post',
                        url: ' http://millionsopportunities.international/webservicefav',
                        data: {
                            'post_id': post_id,
                ...
                $scope.removefavorite = function (id) {
                    ...
                    $http({
                        method: 'post',
                        url: ' http://millionsopportunities.international/webserviceunfav',
                        data: {
                            'id': fav_id,
    ...
    .controller('manageAdsCtrl',
        function ($scope, $state, $http, $ionicPopup, $ionicLoading, $ionicPlatform, $stateParams, $ionicPopover) {
            $scope.$on('$ionicView.beforeEnter', function (event, viewData) {
                ...
                $http({
                    method: 'post',
                    url: ' http://millionsopportunities.international/webservicemanage_ad',
                    data: {
                        'email_id': localStorage['rEmail']
                    ...
                    if (data.response) {
                        ...
                        if(angular.fromJson(data.result[0])==undefined)
                  {
                     var alertPopup = $ionicPopup.alert({
                        title: 'Alert',
                        template: 'No Add found !!!. '
                    });
                    alertPopup.then(function (res) {
                       // console.log('Logged-In successfully! ');
                       // $state.go('tabsController.millionOpportunities');
                ...
                $scope.delete = function (qwerty) {
                    ...
                    $http({
                        method: 'post',
                        url: ' http://millionsopportunities.international/webservicedelete_ad',
                        data: {
                            'id': addid
...
.controller('editpostAddCtrl',
        function ($scope, $state, $http, $ionicPopup, $cordovaFileTransfer, $ionicLoading, $ionicPlatform, $ionicSideMenuDelegate, $stateParams, $ionicPopover, $cordovaCamera, $cordovaImagePicker) {
               ...
               // console.log('postid page 1 ' + localStorage['post_id'])
                ...
                $http({
                    ...
                    if (data.response) {
                        ...
                        $scope.sub_category=data.result.sub_category;
                        $scope.timedata = data.c_time;
                        $scope.emailcheck = localStorage['rEmail'];
         ...
         sererror = function () {
                ...
                $scope.next = function (data,editsub,sub) {
                    console.log("next"+data)
                     console.log("next"+sub)
                      console.log("next"+editsub)

                        if(editsub==sub){
                            var editsubcat=editsub;
                        }
                    ...
                    if (data == 'Motors') {
                        ...
                        localStorage.setItem('esubcategory', editsubcat);
    ...
    .controller('editpostAddCtrl2',
        function ($scope, $state, $http, $ionicPopup, $cordovaFileTransfer, $ionicLoading, $ionicPlatform, $ionicSideMenuDelegate, $stateParams, $ionicPopover, $cordovaCamera, $cordovaImagePicker) {
            ...
            $scope.$on('$ionicView.beforeEnter', function (event, viewData) {
                ...
                $http({
                    method: 'post',
                    url: ' http://millionsopportunities.international/webservicephotos',
                    data: {
                        'id': localStorage['eeditid'],
                    },
                    headers: {
                ...
                $scope.post = function () {
                    ...
                    $http({
                        method: 'POST',
                        url: ' http://millionsopportunities.international/webserviceedit_post_ad',
                        data: {
                ...
                $scope.imagedelete = function (imagename) {
                    ...
                    $http({
                        method: 'post',
                        url: ' http://millionsopportunities.international/webservicedelete_upload_photo',
                        data: {
            ...
            $scope.takePicture = function (options) {
                ...
                console.log(options);
                $cordovaCamera.getPicture(options).then(function (imageData) {
                    var url = encodeURI(" http://millionsopportunities.international/webserviceedit_upload_photo/" + localStorage['edit_id'] + '/' + localStorage['edit_img']);
                    var fileUrl = imageData;
                    $scope.picture = imageData.split('?')[0];
                    var filename = imageData.split('?')[0];
                    console.log($scope.picture);
...
.controller('filterimageCtrl', // The following is the constructor function for this page's controller. See https://docs.angularjs.org/guide/controller
    ...
    function ($scope, $state, $http, $ionicPopup, $ionicLoading, $cordovaFileTransfer, $ionicPopover, $cordovaDevice, $ionicPlatform, $ionicSideMenuDelegate, $stateParams, $cordovaSocialSharing) {
        $ionicSideMenuDelegate.canDragContent(false);
        $scope.$on('$ionicView.beforeEnter', function (event, viewData) {
            $scope.userlogin = localStorage['auth']
            console.debug('[StoryController] $ionicView.beforeEnter');
            ...
            $http({
                method: 'post',
                url: ' http://millionsopportunities.international/webservicecategory',
                data: {
        ...
        $scope.like = function (id) {
            ...
            $http({
                method: 'post',
                url: ' http://millionsopportunities.international/webservicelike',
                data: {
                    'post_id': post_id,
                    'user_email': localStorage['rEmail']
        ...
        $scope.unlike = function (id) {
            ...
            $http({
                method: 'post',
                url: ' http://millionsopportunities.international/webserviceunlike',
                data: {
                    'id': post_id,
                },
                headers: {
...
.controller('favouriteCtrl', // wing is the constructor function for this page's controller. See https://docs.angularjs.org/guide/controller
    // You can include any angular dependencies as parameters for this function
    // TIP: Access Route Parameters for your page via $stateParams.parameterName
    function ($scope, $state, $http, $ionicPopup, $ionicLoading, $ionicPlatform, $stateParams, $ionicPopover) {
        $scope.$on('$ionicView.beforeEnter', function (event, viewData) {
            ...
            $http({
                method: 'post',
                url: ' http://millionsopportunities.international/webserviceuser_fav',
                data: {
                    'user_email': localStorage['rEmail']
...
.controller('settingCtrl',
    function ($scope, $ionicHistory, $state, $http, $cordovaToast, $ionicPopup, $ionicLoading, $cordovaFileTransfer, $cordovaDevice, $ionicPlatform, $ionicSideMenuDelegate, $stateParams, $ionicPopover) {
        $scope.$on('$ionicView.beforeEnter', function (event, viewData) {
            ...
            $scope.logincheck = localStorage['auth'];
        ...
        $scope.Subscribe = function (a) {
            ...
            $http({
                method: 'POST',
                url: ' http://millionsopportunities.international/webservicenewsletter_subs',
                data: {
                    'email': email,
        ...
        $scope.feedback = function (a, b, c, d, e) {
            ...
            $http({
                method: 'POST',
                url: ' http://millionsopportunities.international/webservicefeedback',
                data: {
                    'experience': exp,
                    'difficulty': def,
                    'improve_service': enh,
...
.controller('helpCtrl',
    function ($scope, $state, $http, $ionicPopup, $ionicLoading, $ionicPlatform, $stateParams, $ionicPopover) {
        ...
        $http({
            method: 'post',
            url: ' http://millionsopportunities.international/webservicehelp_us',
            data: {
...
.controller('millionOpportunitiesCtrl',
    function ($scope, $state, $http, $ionicPopup, $ionicLoading, $ionicPlatform, $stateParams, $ionicPopover) {
        $scope.$on('$ionicView.beforeEnter', function (event, viewData) {
            ...
            $http({
                method: 'post',
                url: ' http://millionsopportunities.international/webservicepost_details',
                data: {
                ...
                if (data.response) {
                  ...
                  if(angular.fromJson(data.result[0])==undefined)
                  {
                    ...
                    console.log(angular.fromJson(data.result[0]))
            ...
            $scope.chat = function () {
                ...
                confirmPopup.then(function (res) {
                    if (res) {
                        window.open(' http://millionsopportunities.international/', '_system', 'location=yes');
                        return false
                    }
...
.controller('aboutUsCtrl',
    function ($scope, $state, $http, $ionicPopup, $ionicLoading, $ionicPlatform, $stateParams, $ionicPopover) {
        ...
        $http({
            method: 'post',
            url: ' http://millionsopportunities.international/webserviceabout_us',
            data: {
...
.controller('howItWorkCtrl', function ($scope, $state, $http, $ionicPopup, $ionicLoading, $ionicPlatform, $stateParams, $ionicPopover) {
        ...
        $http({
            method: 'POST',
            url: ' http://millionsopportunities.international/webservicehow_it_works',
            data: {
...
.controller('contactUsCtrl',
    function ($scope, $state, $http, $ionicPopup, $ionicLoading, $ionicPlatform, $ionicSideMenuDelegate, $stateParams, $ionicPopover) {
        ...
        $scope.submit = function () {
            ...
            $http({
                method: 'POST',
                url: ' http://millionsopportunities.international/webservicecontact_and_email',
                data: {
...
.controller('searchCtrl', // The following is the constructor function for this page's controller. See https://docs.angularjs.org/guide/controller
        ...
        function ($scope, $state, $http, $ionicPopup, $cordovaFileTransfer, $ionicLoading, $ionicPlatform, $ionicSideMenuDelegate, $stateParams, $ionicPopover, $cordovaCamera, $cordovaImagePicker) {
            ...
            $scope.search = function (category, searchAdd) {
                console.log("cat" + category);
                console.log("serch" + searchAdd);
                if (category == undefined || category == 'undefined') {
                    ///localStorage['sechcat']=category;

                    var alertPopup = $ionicPopup.alert({
                        title: 'Alert',
                        template: ' Please Select Category First!! '
                    });
                    alertPopup.then(function (res) {
                        // $state.go('tabsController.millionOpportunities');
                    ...
                    localStorage['sechcat'] = category;
                    if (searchAdd == undefined || searchAdd == 'undefined') {
                        var serch = '';
                        console.log("serch" + serch);
                        localStorage['searchAds'] = serch;
                    ...
                    $http({
                        method: 'post',
                        url: ' http://millionsopportunities.international/webservicesearch',
                        data: {
                            'search': localStorage['searchAds'],
                            'category': localStorage['sechcat'],
                        },
                        headers: {
                            'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
                        }
    ...
    .controller('profileCtrl', // The following is the constructor function for this page's controller. See https://docs.angularjs.org/guide/controller
        ...
        function ($scope, $state, $http, $ionicPopup, $cordovaFileTransfer, $ionicLoading, $ionicPlatform, $ionicSideMenuDelegate, $stateParams, $ionicPopover, $cordovaCamera, $cordovaImagePicker) {
            ...
            $scope.contact = function (a, b, c) {
                ...
                $http({
                    method: 'POST',
                    url: ' http://millionsopportunities.international/webserviceupdate_user_info',
                    data: {
                        'email': localStorage['rEmail'],
                        'firstname': first,
                        'lastname': second,
            ...
            $scope.Passwordchanged = function (a, b) {
                ...
                $http({
                    method: 'POST',
                    url: ' http://millionsopportunities.international/webservicechange_user_password',
                    data: {
                        'email': localStorage['rEmail'],
                        'old_password': old,
                        'password': pass,
            ...
            $scope.changeemail = function (a) {
                ...
                $http({
                    method: 'POST',
                    url: ' http://millionsopportunities.international/webservicechange_emailweb',
                    data: {
                        'email': email,
            ...
            $scope.deactivate = function (a) {
                ...
                $http({
                    method: 'POST',
                    url: '  http://millionsopportunities.international/webserviceuser_deactivate',
                    data: {
                        'email': localStorage['rEmail'],
                        'reason': reason,
            ...
            function uploadFile(uri) {
                var url = encodeURI(" http://millionsopportunities.international/webserviceresume_upload");
...
.controller('forgetCtrl', function ($scope, $state, $http, $ionicPopup, $cordovaFileTransfer, $ionicLoading, $ionicPlatform, $ionicSideMenuDelegate, $stateParams, $ionicPopover, $cordovaCamera, $cordovaImagePicker) {
    ...
    $scope.send = function () {
        ...
        $http({
            method: 'POST',
            url: ' http://millionsopportunities.international/webserviceforget_pass',
            data: {
                'email': $scope.email,
