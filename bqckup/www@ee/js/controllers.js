...
$state.go("app.forum2");
localStorage['ki_paya']='discussion';
...
var url_linlk='http://europa.promaticstechnologies.com/zportix/webservices/jmotorsportforumLikes'
}
else if(localStorage['main_game']=='NFL'){
	var url_linlk='http://europa.promaticstechnologies.com/zportix/webservices/jnflforumLikes'
}
$http({
method: 'POST',
url: url_linlk, 
...
if(localStorage['main_game']=='NFL'){
var url_linlk='http://europa.promaticstechnologies.com/zportix/webservices/jnflforumPostLike'
}
else if(localStorage['main_game']=='Motorsport'){
	url_linlk='http://europa.promaticstechnologies.com/zportix/webservices/jmotorsportforumPostLike'

}
else if(localStorage['main_game']=='Football'){
	url_linlk='http://europa.promaticstechnologies.com/zportix/webservices/jforumPostLike'
}
...
//////
$scope.subreplylikes=function(id){

	var subreply_id=id;
console.log("subreply_id"+subreply_id);
$ionicLoading.show({
template: 'Please Wait...'
});
if(localStorage['main_game']=='NFL'){
var url_linlk='http://europa.promaticstechnologies.com/zportix/webservices/jnflforumPostSublikes'
}
else if(localStorage['main_game']=='Motorsport'){
	url_linlk='http://europa.promaticstechnologies.com/zportix/webservices/jmotorsportforumPostSublikes'
}
else if(localStorage['main_game']=='Football'){
	url_linlk='http://europa.promaticstechnologies.com/zportix/webservices/jforumPostSublikes'
}
...
var team_id=localStorage['hod'];
	...
	var url_linlk='http://europa.promaticstechnologies.com/zportix/webservices/jforumQouteReply/';
	var main_game_id='3';
	var team_id=localStorage['nfl_id'];
}
...
function($scope, $http, Category,$stateParams, $ionicLoading,$state,$ionicPopup) {
	...
	$scope.$on('$ionicView.beforeEnter',function(event, viewData) {
	if(localStorage['ki_paya']=='discussion'){
		localStorage['current_quote']="";
		$scope.descr="";
		console.log('balle shava mundia......');
	}else if(localStorage['ki_paya']=='quote') {
				console.log('balle shava kudiye......');
...
$scope.$on('$ionicView.beforeEnter', function(event, viewData) {
		//console.log("football"+localStorage['flag']);
  football
  console.log("football"+localStorage['flag']);
});
...
$scope.$on('$ionicView.beforeEnter', function(event, viewData) {
	//localStorage['flag']='1';
	$scope.flagcheck=localStorage['flag'];
$ionicSideMenuDelegate.toggleRight(false);
...
.controller('CategoryCtrl', function($scope, Category, $stateParams,$state) {
	$scope.$on('$ionicView.beforeEnter', function(event, viewData) {
		console.log("football"+localStorage['flag']);
...
if(localStorage['main_game']=="Football" ||"Motorsport"){


$scope.title=localStorage['main_game']
}
else if(localStorage['main_game']=="NFL"){
	$scope.title=localStorage['nfl_id']
}
